...
struct TransformedCube {
    int x2, y2, z2;
};

struct Cube a[8] = {0}, t[8] = {0}, f[8] = {0}, g[8] = {0}, k[8] = {0}, l[8] = {0};
struct TransformedCube b[8] = {0}, c[8] = {0}, d[8] = {0}, e[8] = {0}, h[8] = {0}, j[8] = {0};

void init();
void create();
void drawCube(struct TransformedCube v[]);
void rotate();
    ...
    do {
        ...
        switch (ch) {
            ...
            case 3:
                ...
                init();
                flushall();
                printf("Enter the scaling vector (sx sy sz): ");
...
void drawCube(struct TransformedCube v[]) {
    ...
    line(v[7].x2, v[7].y2, v[4].x2, v[4].y2);
    ...
    line(v[0].x2, v[0].y2, v[0].x2, v[0].y2 - 50);
    line(v[1].x2, v[1].y2, v[1].x2, v[1].y2 - 50);
    line(v[2].x2, v[2].y2, v[2].x2, v[2].y2 - 50);
    line(v[3].x2, v[3].y2, v[3].x2, v[3].y2 - 50);

    line(v[4].x2, v[4].y2, v[4].x2, v[4].y2 - 50);
    line(v[5].x2, v[5].y2, v[5].x2, v[5].y2 - 50);
    line(v[6].x2, v[6].y2, v[6].x2, v[6].y2 - 50);
    line(v[7].x2, v[7].y2, v[7].x2, v[7].y2 - 50);
